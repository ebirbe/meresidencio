...
class Publicacion_Controller extends Template_Controller
{
	...
	if ($_POST)
	{
		...
		$this->servicios_sel = $datos['servicio'];
	    //Reponemos las cercanias seleccionadas
	    if (isset($datos['cercania']))
		$this->cercanias_sel = $datos['cercania'];
	...
	if ($this->_validar())
	{
	    ...
	    if (isset($datos['servicio']))
		$publicacion->servicios = $datos['servicio'];
	    if (isset($datos['cercania']))
		$publicacion->cercanias = $datos['cercania'];
